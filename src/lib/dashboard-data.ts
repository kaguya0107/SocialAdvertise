...
const seed = (n: number, amp: number, base: number) =>
  Array.from({ length: 24 }, (_, i) => ({
    ...
    y:
      base +
      Math.sin(i / 2.4 + n) * amp +
      Math.cos(i / 1.7) * (amp / 2) +
      (Math.random() - 0.5) * (amp / 3),
  }));
...
export const creatives: CreativeRow[] = [
  ...
  },
  {
    ...
    metrics: {
      ...
      TikTok: { ctr: 2.1, cpa: 1640, cv: 198, spend: 280000, roas: 320 },
  ...
  },
  {
    ...
    metrics: {
      ...
      Google: { ctr: 1.1, cpa: 2840, cv: 88, spend: 260000, roas: 210 },
    },
  },
  {
    id: "c4",
...
export const liveEvents = [
  {
    t: "now",
    text: "TikTok / Glow Beauty Salon — 新規CV 1件 (+¥9,800)",
    platform: "TikTok" as Platform,
  },
  {
    t: "12s",
    text: "Meta / Aurora Cosmetics — クリエイティブ自動入替",
    platform: "Meta" as Platform,
  },
  {
    t: "38s",
    text: "Google / Velvet Hair Lounge — CPC -¥18 (改善)",
